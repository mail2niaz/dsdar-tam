...
public class ContactsListActivity extends FragmentActivity implements
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		String parentActivity = getIntent().getSerializableExtra(
				"parentActivity").toString();
		processName = parentActivity;
		if (parentActivity.equals("Add Team Member")) {
			System.out
					.println("============ Entered the if condition ===========");
			itsTeamNameEt = (EditText) findViewById(R.id.etTeamName);
			// niaz home
			itsTeamNameEt.setText(getIntent().getSerializableExtra("teamName")
					.toString());
